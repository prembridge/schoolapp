...
//   console.log((localStorage.getItem("fkid")),localStorage.getItem("pkid"))
...
//     .then(response =>  response.json())
//     .then(json => {setLpay(json.data[0].Display_Date)})
...
//     var n = addMonths(new Date(dat),12).toLocaleString().slice(0,8);
//   }
//   else if (PaymentType =="halfYearly") {
//     var n = addMonths(new Date(dat),6).toLocaleString().slice(0,8);
//   }
//   else if (PaymentType =="quarterly") {
//     var n = addMonths(new Date(dat),3).toLocaleString().slice(0,8);
//   }
//   else if (PaymentType =="monthly"){
//     var n = addMonths(new Date(dat),1).toLocaleString().slice(0,8);
//   }
...
//           <p>Last Payment: <b>{moment(lpay).format('DD-MM-YYYY')}</b> Amount paid: <b>₹{Inst}</b></p>  
//                   {/* {lpay} */}
//                   <p>Next Payment: <b>{moment(n).format('DD-MM-YYYY')} </b>Amount to be paid: <b>₹{Inst}</b></p>
